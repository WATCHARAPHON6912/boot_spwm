...
int d = 0;
int li = 2;
unsigned long period = 15;         //ระยะเวลาที่ต้องการรอ
...
int duty_boot = 0;
// int boot_li = 80;
int boot_li = map(50, 0, 100, 0, clk_boot);
// int boot_set = 200;
int boot_set = 200;
void loop() {
